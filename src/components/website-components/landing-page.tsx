                ...
                >
                  ...
                  <span className="text-blue-600">
                    <RotatingText
                      ...
                      mainClassName="px-2 sm:px-2 md:px-3 text-blue-600 text-black overflow-hidden py-0.5 sm:py-1 md:py-1 max-sm:justify-center justify-start rounded-lg"
                      staggerFrom={"last"}
                      initial={{ y: "100%" }}
                      animate={{ y: 0 }}
                      exit={{ y: "-120%" }}
